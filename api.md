...
**Warning**: You can only convert a plain Postgres table into a
...
**Warning**: Altering a table's schema is quite efficient provided that its
...
**Note**: The rows that belong to a single batch INSERT command do **not**
