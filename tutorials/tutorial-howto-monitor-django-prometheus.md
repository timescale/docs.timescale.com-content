...
>:TIP: Since machines commonly have multiple versions of Python
installed,
in this tutorial we will call pip using the `python -m pip [foo]` syntax instead 
...
>:TIP: Replace the job_name “django” with whatever you’d like as a prefix for
