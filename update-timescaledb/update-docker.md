...
Install the current TimescaleDB x.y.z image:

```bash
docker pull timescale/timescaledb:x.y.z-pg12
```
>:TIP: If you are using PostgreSQL 11 images, use the tag `x.y.z-pg11`.
